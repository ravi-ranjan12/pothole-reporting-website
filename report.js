      ...
      (error) => {
        ...
        switch (error.code) {
          case error.PERMISSION_DENIED:
            errorMsg = "❌ Location access denied. Please allow location in your browser.";
            break;
          case error.POSITION_UNAVAILABLE:
            errorMsg = "❌ Location unavailable. Please check your GPS settings.";
            break;
          case error.TIMEOUT:
            errorMsg = "❌ Location request timed out. Try clicking GPS button.";
            break;
          default:
            errorMsg = "📍 Using default location. Click GPS button to detect your location.";
        }
        ...
        (error) => {
          ...
          switch (error.code) {
            case 1: // PERMISSION_DENIED
              errorMsg = "❌ Location access DENIED. Click the 🔒 icon in your browser's address bar → Allow Location. Then try again.";
              break;
            case 2: // POSITION_UNAVAILABLE
              errorMsg = "❌ Location unavailable. Check: Windows Settings → Privacy → Location → Turn ON for apps and browser.";
              break;
            case 3: // TIMEOUT
              errorMsg = "❌ Location timed out. Try again or type address manually above.";
              break;
            default:
              errorMsg = "❌ Could not get location. Please type address manually.";
          }
          gpsStatus.textContent = errorMsg;
          gpsStatus.style.color = "#dc2626";
        },
